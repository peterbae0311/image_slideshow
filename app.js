...
// ============================================================
const GOOD_TEXTS = [
  '봄비가 내리는 오후, 창문에 맺힌 빗방울들이 유리를 타고 천천히 흘러내렸다. 나는 그 물줄기를 눈으로 따라가며 아무 생각도 하지 않았고, 그 무심함이 오히려 마음을 맑게 씻어주는 것 같았다.',
  '오래된 책장을 넘기면 어디선가 오래된 시간의 냄새가 풍긴다. 그것은 먼지와 종이와 누군가의 손길이 뒤섞인 냄새인데, 나는 그 냄새를 맡을 때마다 혼자가 아니라는 이상한 안도감을 느끼곤 했다.',
  '그녀가 떠난 자리에 찻잔 하나가 남겨져 있었다. 손잡이가 살짝 금 간 그 찻잔에는 아직 온기가 남아 있었고, 나는 한참을 그 자리에 서서 식어가는 그 온도를 바라보았다.',
  '가을 저녁의 냄새는 설명하기가 어렵다. 낙엽과 흙과 멀리서 흘러오는 연기가 뒤섞인 그 냄새는, 이상하게도 슬프기보다는 안도에 가까운 감정을 건드린다. 돌아갈 곳이 있다는 느낌 같은 것.',
  '그는 말이 없는 사람이었다. 그러나 그의 곁에 있으면 세상이 조금 더 조용해지고, 그 조용함 속에서 오히려 더 많은 것들이 들려오는 것 같았다. 침묵에도 종류가 있다는 걸 그에게서 배웠다.',
  '강물은 바위를 부수지 않는다. 다만 오랜 시간을 흘러 바위 곁을 스쳐 지나면서, 어느 날 문득 그것을 부드럽게 만들어버린다. 서두르지 않아도 닿을 수 있다는 것을 강은 언제나 조용히 보여준다.',
  '첫눈이 내리던 밤, 우리는 아무 말도 없이 나란히 앉아 창밖을 바라보았다. 눈송이가 가로등 빛 아래 천천히 내려앉는 것을 보며, 이 순간이 기억 속에 오래 남겠다고 나는 생각했다.',
  '삶이란 완성된 그림이 아니라고 그녀는 말했다. 매일 조금씩 덧칠해 가는 수채화 같은 것이라서, 실수한 자리도 지우지 않고 그냥 그 위에 다시 색을 올리면 된다고. 그 말이 오래 마음에 남았다.',
  '저녁 햇살이 부엌 창을 비스듬히 물들이는 순간이 있다. 겨우 몇 분밖에 되지 않는 그 시간에 나는 이상하게 멈추게 된다. 이 작은 일상이 사실은 얼마나 귀한 것인지를, 그 빛이 매번 일깨워준다.',
  '기억은 사진보다 정직하다. 사진은 찰나를 담지만 기억은 그때의 온도와 냄새와 바람의 방향까지 함께 보관한다. 그래서 어떤 기억은 꺼낼 때마다 그날로 데려다 놓는 것처럼 생생하게 살아난다.',
  '어머니의 손은 항상 내 이마보다 조금 더 차가웠다. 열이 날 때 그 손이 이마 위에 얹히면 세상이 잠시 멈추는 것 같았고, 나는 그 서늘함이 세상에서 가장 따뜻한 것이라는 걸 한참 후에야 알았다.',
  '그해 여름, 우리는 선풍기 소리를 배경 삼아 오랜 이야기를 나눴다. 서로의 어린 시절과 부끄러운 기억들을 꺼내가며 웃었고, 그 이야기들은 지금도 바람이 부는 날이면 어딘가에서 살랑거리는 것 같다.',
  '소년은 별을 세다 잠들었다. 열일곱 번째 별에서 눈꺼풀이 무거워졌고, 꿈속에서도 별들은 그의 주변을 가만히 돌았다. 아무것도 바라지 않던 그 나이의 밤하늘이 어쩌면 가장 넓었을지도 모른다.',
  '우리가 나눈 가장 긴 대화는 말이 없었다. 마주 앉아 같은 음악을 들으며 각자의 생각 속에 잠겨 있던 그 오후가, 어떤 수많은 말들보다 더 깊이 서로를 이해한 시간이었다고 나는 지금도 믿는다.',
  '낡은 골목에 접어들면 시간이 천천히 흐르는 것 같았다. 골목은 서두르는 법이 없었고, 거기 사는 고양이들도 마찬가지였다. 그곳만큼은 세상이 나에게 빨리 가라고 등을 밀지 않았다.',
  '겨울 새벽의 공기는 날카롭지만 그래서 정직하다. 차가운 숨을 깊이 들이마시면 폐 속 구석까지 서늘하게 열리는 느낌이 나는데, 그 순간만큼은 내가 살아 있다는 사실이 아주 선명하게 느껴진다.',
  '그녀는 편지를 쓸 때면 항상 창가에 앉았다. 빛이 있어야 글씨가 예뻐진다고, 그것이 단순한 습관이 아니라 자신이 오랜 시간 지켜온 의식 같은 것이라고 했다. 나는 그 진지함이 좋았다.',
  '비가 그친 직후의 세계는 모든 것이 조금 더 또렷해 보인다. 빛도 다르고 냄새도 다르고, 젖은 아스팔트 위로 하늘이 반사되는 방식도 다르다. 그래서 나는 비 온 뒤의 세상을 유독 좋아한다.',
  '할머니의 손등에는 주름이 가득했다. 어릴 때는 그냥 지나쳤던 그 손을, 어른이 되어 다시 바라보니 주름 하나하나가 살아온 날들의 이야기였다. 그 손을 잡을 수 있을 때 더 많이 잡았어야 했다.',
  '음악이 끝나고 이어지는 짧은 침묵이 있다. 마지막 음이 공기 중에 잠시 머물다 사라지는 그 몇 초 동안, 나는 때때로 세상에서 가장 아름다운 소리를 듣는다. 여운이라는 것은 그런 것이다.',
  '늦은 밤 혼자 끓이는 라면의 온기는 배고픔보다 더 깊은 자리를 채워준다. 그것이 무엇인지 정확히 설명할 수는 없지만, 뜨거운 국물이 목을 타고 내려갈 때 마음 어딘가가 함께 녹는 기분이 든다.',
  '봄이 되면 강변에 나가 한참을 앉아 있곤 했다. 물이 흐르는 소리는 항상 같은데 매번 다르게 들렸고, 그 소리를 듣고 있으면 마음속에 쌓인 먼지 같은 것들이 조용히 씻겨 내려가는 것 같았다.',
  '좋은 사람을 알아보는 방법은 의외로 간단하다. 그 사람과 함께 있을 때 내가 더 좋은 사람이 되고 싶어지는지를 보면 된다. 그런 사람이 곁에 있다는 것은 삶이 주는 가장 조용한 선물이다.',
  '등대는 폭풍 속에서도 자리를 지킨다. 흔들리지 않아서가 아니라, 흔들리면서도 불을 끄지 않기 때문이다. 그것이 존재의 이유를 아는 것과 모르는 것의 차이라고, 나는 그 불빛을 보며 생각했다.',
  '새벽 네 시의 도시는 낮과 전혀 다른 얼굴을 하고 있다. 거리는 솔직해지고 가로등은 외로워 보이고, 드물게 지나가는 차들의 불빛은 왜인지 슬프다. 그 시간에 깨어 있다는 것은 특별한 목격이다.',
  '꽃이 지는 것을 슬퍼하지 않기로 했다. 꽃잎이 떨어지는 것은 끝이 아니라 다음 봄을 위한 가장 조용하고 성실한 준비라는 것을, 나는 해마다 봄이 올 때마다 다시 확인하고 또 잊는다.',
  '어떤 문장은 오래전에 쓰였는데도 꼭 오늘의 나를 위해 쓰인 것처럼 읽힌다. 그럴 때 나는 글이란 시간을 건너는 일이라는 것을 실감한다. 죽은 사람의 목소리가 살아 있는 사람의 가슴에 닿는 일.',
  '사람이 사람에게 기댈 수 있다는 것, 그 단순하고 오래된 사실이 때로는 세상에서 가장 큰 위안이 된다. 특별한 말이 필요한 게 아니었다. 그냥 옆에 있어도 된다는 것을 알게 되는 순간이 있다.',
  '그는 글을 쓸 때 항상 펜을 종이에 댄 채로 한참을 생각했다. 잉크가 살짝 번지도록 그 자리에 멈춰 있는 동안, 그는 무엇을 생각하고 있었을까. 나는 그 정직한 망설임의 흔적을 좋아했다.',
  '두 사람이 같은 방향을 바라볼 때 사랑이 시작된다고 누군가 썼다. 서로를 바라보는 것이 아니라 나란히 서서 같은 것을 함께 보는 것. 그것이 어쩌면 가장 오래 지속되는 사랑의 형태일지 모른다.',
  '겨울이 깊을수록 봄은 더 간절해진다. 그래서 봄꽃은 언제나 그토록 눈부시다. 오랜 추위를 견뎌낸 것들만이 낼 수 있는 그 화사함이, 단순한 아름다움이 아니라 하나의 증언처럼 느껴진다.',
  '말하지 않아도 알아주는 사람이 곁에 있다는 것, 그것이 어쩌면 가장 오래되고 가장 무거운 형태의 사랑일지 모른다. 설명하지 않아도 된다는 안도감이 얼마나 큰 것인지, 잃고 나서야 알게 됐다.',
  '강은 굽어 흐르면서도 결국 바다에 닿는다. 돌아가는 것이 틀린 게 아님을 강은 온몸으로 보여준다. 지름길만이 정답이 아니라는 것을, 굽이굽이 흘러가는 물줄기가 묵묵히 증명하는 셈이다.',
  '첫사랑이 아름다운 것은 돌아오지 않아서가 아니라, 그 시절의 우리가 그토록 순수했기 때문이다. 상처받을 것을 알면서도 뛰어들던 그 무모함이, 지금 생각하면 가장 용감한 순간이었는지도 모른다.',
  '글을 읽는다는 것은 타인의 마음속으로 잠시 이사 드는 일이다. 낯선 방에 앉아 그 사람의 창문으로 세상을 내다보다가, 돌아올 때 우리는 언제나 전과 조금 다른 사람이 되어 있다.',
  '그 사람이 떠난 뒤에도 그 사람이 좋아하던 노래는 여전히 흘러나왔다. 음악은 사람보다 오래 남는다. 그것이 위로인지 아픔인지 한동안 알 수 없었지만, 결국 나는 그 노래를 끄지 않기로 했다.',
  '사랑한다는 말을 아끼는 사람들이 있다. 쉽게 꺼내지 않는 것은 냉정함이 아니라, 그 말이 얼마나 무거운지를 너무 잘 알기 때문이다. 그런 사람에게 그 말을 듣는다면 그것은 대단한 일이다.',
  '눈이 내리는 밤이면 세상이 한 겹 더 조용해진다. 그 고요 속에서 오래된 것들이 고개를 든다. 잊고 지냈던 얼굴들, 미처 하지 못한 말들, 그리고 아직도 마음 어딘가에 남아 있는 이름들이.',
  '삶의 아름다움은 완벽한 날들이 아니라 허술하고 평범한 날들 사이에서 문득 빛나는 순간들에 있다. 뜻밖의 웃음, 우연히 마신 따뜻한 커피, 퇴근길에 만난 석양. 그런 것들이 삶을 살게 한다.',
  '나는 그 사람의 발소리만 들어도 알 수 있었다. 현관에서 들려오는 걸음걸이만으로 오늘의 기분을 읽을 수 있었다. 사랑이란 그런 것이다. 말보다 먼저, 몸이 기억하는 것.',
  '하루가 끝날 때 오늘 나는 누구에게 친절했는가를 가만히 떠올려본다. 크지 않아도 된다. 문을 잡아주거나 눈을 마주치며 웃어주는 것으로 충분하다. 그것만으로도 하루를 정리하는 데 부족함이 없다.',
  '저녁 연기가 피어오르는 굴뚝을 보면 이상하게 마음이 놓인다. 저기 누군가 있다는 것, 그 사람이 지금 따뜻한 무언가를 만들고 있다는 것만으로, 세상이 아직 괜찮다는 생각이 들었다.',
  '여름밤 풀벌레 소리는 지구의 가장 오래된 자장가다. 그 소리를 들으며 누워 있으면 잠이 오기 전에 먼저 마음이 잠드는 것 같다. 복잡한 것들이 하나씩 자리를 비우고 고요함이 스며드는 시간.',
  '그녀가 남긴 마지막 편지는 짧았다. 그러나 그 짧음 속에 오랜 시간 하지 못했던 모든 말들이 눌려 있었다. 짧게 쓰인 문장이 어떻게 그렇게 오래 마음에 남을 수 있는지, 지금도 이해하지 못한다.',
  '오래된 장소에는 시간이 켜켜이 쌓인 냄새가 있다. 처음 온 곳인데도 낯설지 않은 그 기분은, 어쩌면 이 공간이 기억하는 수많은 사람들의 온기가 아직 남아 있기 때문인지도 모른다.',
  '사계절이 바뀌어도 같은 자리에 서 있는 나무를 보면 이상하게 안심이 된다. 변하지 않는 것들이 있다는 사실이, 모든 것이 빠르게 달라지는 세상에서 어떤 위안이 된다. 뿌리가 깊은 것들의 고요함.',
  '꿈은 이루어지기 전까지 빛난다고 했지만, 이루어지지 않은 꿈도 제 나름의 빛을 낸다. 어떤 꿈들은 현실이 되지 않았기 때문에 오히려 더 오래, 더 아름다운 형태로 마음속에 남아 있기도 하니까.',
  '그가 웃을 때 눈이 먼저 웃었다. 입술이 따라가기도 전에 눈가에 주름이 잡혔고, 그 순서가 나는 늘 좋았다. 가짜로는 흉내 낼 수 없는 그 순서가, 그 사람이 진심이라는 증거였다.',
  '봄이 오는 소리는 눈에 보이기 전에 먼저 들린다. 겨우내 닫혀 있던 창문을 열었을 때 들어오는 공기의 온도, 이름 모를 새소리, 어딘가 젖은 흙 냄새. 봄은 언제나 그렇게 조용히 먼저 와 있다.',
  '나는 여행지에서 산 기념품보다 그곳의 공기와 골목과 낯선 언어의 소리를 더 오래 기억한다. 가져올 수 없는 것들이 오히려 더 깊이 남는다. 기억은 담을 수 없는 것들로 가득 차 있다.',
  '가장 오래된 나무는 뿌리가 가장 깊다. 폭풍이 지나간 뒤 그 자리에 남아 있는 것들은 대개 그런 것들이다. 오래 버틴 것들, 소리 없이 깊어진 것들, 보이지 않는 곳에서 자란 것들.',
  '그 골목을 다시 걸었다. 모든 것이 변해 있었지만 골목의 굽는 방식만큼은 그대로였다. 장소는 기억한다. 사람이 다 잊어버린 것들을, 돌과 흙과 시간이 대신 붙잡고 있다.',
  '어떤 인연은 처음 만나는 순간 이미 오래된 것 같은 느낌을 준다. 낯섦과 익숙함이 동시에 존재하는 그 이상한 감각이, 사람과 사람 사이에 전생이 있다는 믿음을 설명해줄지도 모른다.',
  '글을 쓴다는 것은 자신의 내면에 손을 뻗는 일이다. 무엇이 잡힐지 모른 채로 손을 넣고, 조심스럽게 꺼낸 것을 언어라는 그릇에 담는다. 그 과정에서 우리는 자신이 무엇인지를 조금씩 알게 된다.',
  '사람은 떠날 때보다 떠난 뒤에 더 많은 것을 남긴다. 빈 의자, 익숙한 냄새, 누군가가 그 사람처럼 웃을 때의 흠칫함. 존재는 사라지지 않는다. 다만 다른 형태로 남아 계속 살아간다.',
  '산길을 오르다 잠시 멈추어 아래를 내려다보면, 그제야 내가 얼마나 멀리 왔는지가 보인다. 올라가는 동안에는 보이지 않던 것들이 잠깐 서는 것만으로도 눈에 들어온다. 쉬는 것이 멈추는 게 아니다.',
  '그 사람 곁에 있으면 말을 하지 않아도 괜찮았다. 서로의 침묵이 불편하지 않다는 것을 알게 되던 날, 나는 이 사람과 오래 함께할 수 있겠다고 처음으로 생각했다. 침묵의 편안함은 신뢰에서 온다.',
  '저녁 어스름이 내려앉는 시간, 하루가 접히는 그 짧은 순간이 나는 좋다. 아직 밤이 되지 않았고 이미 낮도 지나간 그 틈새에, 세상이 잠깐 숨을 고르는 것처럼 느껴지는 그 시간이 좋다.',
  '기다린다는 것은 믿는다는 것이다. 반드시 올 것이라는 확신 없이는 기다릴 수 없다. 그래서 오래 기다린 것들이 마침내 왔을 때 우리는 그것을 기적이라 부르지 않고 당연한 것처럼 받아들인다.',
];
